...
#pragma region input n
	double n;
	cout << "input natural number n" << endl;
	cin >> n;

	for (bool i = 0; i != 1;)
	{
		if (cin.fail() || (floor(n) != ceil(n)) || (n < 3)) {//floor biggest int x thats smaller ot equal than a; ceil smallest int x thats bigger or equal than a; if floor == ceil, than a - int
